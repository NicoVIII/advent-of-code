Place your input.txt with the input provided by Advent of Code into the directory you plan to run the code from, e.g. `2023/fsharp/`
and run `dotnet run --project <day>/src` to get the solution.
